...
function checkRule(rule) {
  ...
  const handler = {
    ...
    git() {
      ...
      const currentBranchName = childProcess.execSync('git branch --show-current').toString()
      if (!sourceBranch) {
      ...
      // TODO: 检查目标分支是否有更新
      // TODO: 获取目标分支的head处hash
      // TODO: 检查源分支提交中是否包含该hash
      // 如果包含, 说明master没有更新, 检查通过; 否则说明master有更新, 检查不通过
      console.log('checkTargetBranch', checkTargetBranch)
      return false
    },
  }
